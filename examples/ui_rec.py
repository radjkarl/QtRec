...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2_rec = QtRecGui.QPushButton(self.centralwidget)
        ...
        self.pushButton_rec = QtRecGui.QPushButton(self.centralwidget)
        self.pushButton_rec.setGeometry(QtCore.QRect(370, 50, 98, 27))
        self.pushButton_rec.setObjectName(_fromUtf8("pushButton_rec"))
        self.tableWidget_rec = QtRecGui.QTableWidget(self.centralwidget)
        ...
        self.textEdit_rec = QtRecGui.QTextEdit(self.centralwidget)
